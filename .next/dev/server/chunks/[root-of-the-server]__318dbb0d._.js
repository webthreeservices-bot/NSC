...
"[project]/lib/db-health.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$health$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db-health.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$health$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$health$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
if (!JWT_REFRESH_SECRET) {
    ...
    throw new Error('JWT_REFRESH_SECRET must be configured for authentication');
}
async function POST(request) {
    try {
        // Check database connection health before proceeding
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2d$health$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ensureDatabaseConnection"])();
        } catch (dbError) {
        ...
        let decoded;
        try {
            decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(refreshToken, JWT_REFRESH_SECRET);
        } catch (error) {
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["queryOne"])(`SELECT id, email, "isAdmin", "isActive" FROM "User" WHERE id = $1`, [
            decoded.userId
        ]);
        ...
        const newAccessToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sign({
            userId: user.id,
            email: user.email,
        ...
        const newRefreshToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sign({
            userId: user.id,
            email: user.email
        }, JWT_REFRESH_SECRET, {
            expiresIn: '7d'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__318dbb0d._.js.map