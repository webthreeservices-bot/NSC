...
"[project]/app/api/admin/bot-packages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    // Check admin
    const adminCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])(user);
    if (adminCheck instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]) return adminCheck;
    try {
        // Get all user packages with user details
        const packages = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["query"])(`
      SELECT
        p.id,
        p."userId",
        p."packageType",
    ...
    `);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Failed to fetch bot packages'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    ...
    try {
        ...
        if (!userId || !packageType || !amount || !roiPercentage) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Missing required fields: userId, packageType, amount, roiPercentage'
            }, {
                status: 400
            });
        }
        ...
        if (!validPackageTypes.includes(packageType)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: `Invalid packageType. Must be one of: ${validPackageTypes.join(', ')}`
            }, {
                status: 400
            });
        }
        // Create new package
        const newPackageResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["query"])(`
      INSERT INTO "Package" (
    ...
    `, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Failed to create bot package'
        }, {
            status: 500
        });
    }
...
async function PUT(request) {
    ...
    try {
        ...
        params.push(id);
        // Update package
        const updatedPackageResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["query"])(`
      UPDATE "Package"
      SET ${updates.join(', ')}
      WHERE id = $${paramCount}
    ...
    `, params);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Failed to update bot package'
        }, {
            status: 500
        });
    }
...
async function DELETE(request) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["execute"])(`
      UPDATE "Package"
    ...
    `, [
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Failed to delete bot package'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f4719fc._.js.map