...
"[project]/app/api/packages/my-packages/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    `;
        const [packagesResult, countResult] = await Promise.all([
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["query"])(packagesQuery, [
                user.userId,
                where.status,
                limit,
                skip
            ]),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["query"])(countQuery, [
                user.userId,
                where.status
            ])
        ]);
        ...
        const serializedPackages = packages.map((pkg)=>({
                ...
                roiPayments: pkg.roiPayments?.map((payment)=>({
                        ...payment,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff1dfe37._.js.map